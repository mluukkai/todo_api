...
class TodoItemsControllerTest < ActionController::TestCase
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post :create, todo_item: { description: @todo_item.description, done: @todo_item.done, estimate: @todo_item.estimate, name: @todo_item.name, user_id: @todo_item.user_id }
    end
  ...
  test "should update todo_item" do
    patch :update, id: @todo_item, todo_item: { description: @todo_item.description, done: @todo_item.done, estimate: @todo_item.estimate, name: @todo_item.name, user_id: @todo_item.user_id }
    assert_redirected_to todo_item_path(assigns(:todo_item))
  end
